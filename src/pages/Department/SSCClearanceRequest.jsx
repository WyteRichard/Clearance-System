        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    ...
                    <button className={styles.whiteButton} onClick={() => navigate('/ssc-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Supreme Student Council Clearance Requests</h2>
