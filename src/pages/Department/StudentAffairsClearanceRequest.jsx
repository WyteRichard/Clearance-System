        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    <button className={styles.ghostButton} onClick={() => navigate('/student-affairs-dashboard')}>
                        <img src={homeIcon} alt="Dashboard" className={styles.navIcon} />
                        Dashboard
                    </button>
                    <button className={styles.whiteButton} onClick={() => navigate('/student-affairs-clearance-request')}>
