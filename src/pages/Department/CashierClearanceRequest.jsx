...
const CashierClearanceRequest = () => {
    ...
    useEffect(() => {
        ...
        if (!role || role !== 'ROLE_ROLE_CASHIER' || !exp || exp * 1000 < currentTime) {
            handleLogout();
        } else {
            fetchSemesterData();
        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    <button className={styles.ghostButton} onClick={() => navigate('/cashier-dashboard')}>
                        <img src={homeIcon} alt="Dashboard" className={styles.navIcon} />
                        Dashboard
                    </button>
                    <button className={styles.whiteButton} onClick={() => navigate('/cashier-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Cashier Clearance Requests</h2>
