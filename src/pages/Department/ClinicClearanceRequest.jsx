        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    ...
                    <button className={styles.whiteButton} onClick={() => navigate('/clinic-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Clinic Clearance Requests</h2>
...
export default ClinicClearanceRequest;