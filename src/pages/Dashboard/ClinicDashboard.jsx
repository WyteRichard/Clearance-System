...
const ClinicDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!role || role !== 'ROLE_ROLE_CLINIC' || !exp || exp * 1000 < currentTime) {
            handleLogout();
        } else {
            fetchSemesterData();
            fetchCounts();
        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    <button className={styles.whiteButton} onClick={() => navigate('/clinic-dashboard')}>
                        <img src={dashIcon} alt="Dashboard" className={styles.navIcon} />
                        Dashboard
                    </button>
                    <button className={styles.ghostButton} onClick={() => navigate('/clinic-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Clinic Dashboard</h2>
