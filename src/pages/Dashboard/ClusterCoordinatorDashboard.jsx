...
const ClusterCoordinatorDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!role || role !== 'ROLE_ROLE_COORDINATOR' || !exp || exp * 1000 < currentTime) {
            handleLogout();
        } else {
            fetchSemesterData();
            fetchCounts();
        ...
        <div className={styles.flexContainer}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Cluster Coordinator Dashboard</h2>
...
export default ClusterCoordinatorDashboard;
