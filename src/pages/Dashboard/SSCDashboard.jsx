...
const SSCDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!role || role !== 'ROLE_ROLE_COUNCIL' || !exp || exp * 1000 < currentTime) {
            handleLogout();
        } else {
            fetchSemesterData();
            fetchCounts();
        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    <button className={styles.whiteButton} onClick={() => navigate('/ssc-dashboard')}>
                        <img src={dashIcon} alt="Dashboard" className={styles.navIcon} />
                        Dashboard
                    </button>
                    <button className={styles.ghostButton} onClick={() => navigate('/ssc-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Supreme Student Council Dashboard</h2>
