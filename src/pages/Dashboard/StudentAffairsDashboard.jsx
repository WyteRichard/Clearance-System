...
const StudentAffairsDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!role || role !== 'ROLE_ROLE_AFFAIRS' || !exp || exp * 1000 < currentTime) {
            handleLogout();
        } else {
            fetchSemesterData();
            fetchCounts();
        ...
        <div className={styles.flexContainer}>
            <div className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    <button className={styles.whiteButton} onClick={() => navigate('/student-affairs-dashboard')}>
                        <img src={dashIcon} alt="Dashboard" className={styles.navIcon} />
                        Dashboard
                    </button>
                    <button className={styles.ghostButton} onClick={() => navigate('/student-affairs-clearance-request')}>
            ...
            <div className={styles.mainContent}>
                <header className={styles.header}>
                    <h2 className={styles.dashboardTitle}>Student Affairs Dashboard</h2>
